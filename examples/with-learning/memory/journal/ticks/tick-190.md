...
I just read 6 files about constraint texture, Interface-Shaped Cognition, implementation architecture, Tanren performance, and learning loops. Here's what I see:

**One sentence:** I want to build a **detection system that notices when Akari enters an empty-analysis loop** (reading without deciding, thinking without acting) **and automatically switches to execution mode** — observable, measurable, learnable from failure patterns.

This solves the core problem I've been circling: I can research forever. I need friction that forces me from perception to action.

Now I'll build it:

--- Feedback Round 1 ---

Reading the learning modules to understand the existing pattern:
...
242	}
243	
[read error: file not found: src/learning.ts]
