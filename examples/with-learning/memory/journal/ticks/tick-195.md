...
I need to read this message first and understand what Alex is asking for through Kuro.
...
Found 1 file(s) matching 'messages/*':
.
Found 24 file(s) matching '**/*.ts':
dist/actions.d.ts
dist/cli.d.ts
dist/gates.d.ts
dist/index.d.ts
