...
export { createGateSystem, defineGate, createOutputGate, createSymptomFixGate, type GateSystem, type GateSpec } from './gates.js'
export { createActionRegistry, builtinActions, type ActionRegistry } from './actions.js'
