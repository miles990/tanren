...
export { createGateSystem, defineGate, createOutputGate, createAnalysisWithoutActionGate, createProductivityGate, createSymptomFixGate, createGroundBeforeOpineGate, createWriteThroughGate, createCommitmentGate, type GateSystem, type GateSpec } from './gates.js'
